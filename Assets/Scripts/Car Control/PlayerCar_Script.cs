...
//#else
		FrontLeftWheel.motorTorque = Mathf.Abs(EngineTorque / GearRatio[CurrentGear] * (1 - pedalIntensity));
		FrontRightWheel.motorTorque = Mathf.Abs(EngineTorque / GearRatio[CurrentGear] * (1 - pedalIntensity));
		print(pedalIntensity);
		
		FrontLeftWheel.steerAngle = -7 * wheelIntensity;
		FrontRightWheel.steerAngle = -7 * wheelIntensity;
//		print ("else worked");
